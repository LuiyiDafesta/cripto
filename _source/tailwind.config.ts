  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "flash-up": { "0%": { backgroundColor: "hsl(var(--bull) / 0.25)" }, "100%": { backgroundColor: "transparent" } },
        "flash-down": { "0%": { backgroundColor: "hsl(var(--bear) / 0.25)" }, "100%": { backgroundColor: "transparent" } },
